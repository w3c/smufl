...
-   Added `mensuralPunctus` (U+EA11) to [Medieval and Renaissance miscellany](../tables/medieval-and-renaissance-miscellany.md) range ([#235](https://github.com/w3c/smufl/issues/235))
