...
-   Added `mensuralRestMaximaImperfecta` (U+E9F9) to [Medieval and Renaissance rests](../tables/medieval-and-renaissance-rests.md) range ([#226](https://github.com/w3c/smufl/issues/226))
