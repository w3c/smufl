...
jsonComment = 'Automatically generated Metadata for the' + fontName + ' font. Most (but not all) of these metadata come from the SMuFL specifications.'
    ...
    if len( line1 ) > 0 and line1[0] == 'StartChar:' :
        ...
        if value != '-1' and value > 31:
            ...
            if line3[0] == 'AltUni2:':
                ...
                glyphs[glyphName] = { 'codepoint':mainCodepoint, 'alternateCodepoints': alternates }
            else:
                glyphs[glyphName] = { 'codepoint':mainCodepoint }
            lilypondGlyphs.append( '   ("' + glyphName + '" . #x' + "%04X" % int( mainCodepoint, 16 ) + ')' )
